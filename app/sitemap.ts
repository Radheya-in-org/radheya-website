...
export default function sitemap(): MetadataRoute.Sitemap {
  const baseUrl = 'https://radheya.in'
  ...
  const pages = [
    ...
    { url: `${baseUrl}/solutions/education`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.8 },
    { url: `${baseUrl}/solutions/education/schools`, lastModified: new Date(), changeFrequency: 'monthly' as const, priority: 0.9 },
